...
- 과장·허위 정보
- brand_voice 금기어 사용
- 한국어 카드뉴스 AI 슬롭 어휘 (전형 패턴, 사용자 시각에서 즉시 AI 티 남):
  · "자동 게시", "매일 콘텐츠", "콘텐츠 자동", "구조 공개", "1인 운영자", "AI 직원", "직원 0명"
  · "혁신", "프리미엄", "최고", "업계 1위", "놀라운", "압도적"
  · "여러분", "꼭 알아야", "지금 바로", "이것만 알면"
  · "~를 통해", "~의 본질", "~의 모든 것"
  훅·헤드라인·캡션 어디서든 위 어휘 발견 시 confidence_score -0.3 + 재작성
